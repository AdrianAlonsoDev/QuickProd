...
public class UserServiceImpl implements UserService {
    ...
    public UserRegistrationRecord createUser(UserRegistrationRecord userRegistrationRecord) {
        ...
        if (response.getStatus() != 201) {
            throw new ApiException("Error al crear usuario, código de respuesta: " + response.getStatus());
        }
    ...
    private void verifyEmail(String username, UsersResource usersResource) {
        ...
        UserRepresentation userToVerify = users.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new ApiException("Usuario ya verificado"));
    ...
    public void deleteUserById(String userId) {
        try {
            ...
            throw new UsernameNotFoundException("Usuario no encontrado con ID: " + userId + " " + e.getMessage());
        }
    }
